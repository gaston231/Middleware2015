...
public class WebServicePartner {
	...
	public static void main(String[] args) {
		ClassPathXmlApplicationContext context =
			new ClassPathXmlApplicationContext("/META-INF/spring/integration/partnerConf.xml");
...
//		"</PagarFactura>";
		...
		MessageChannel channel = channelResolver.resolveDestination("consultaPartner");
