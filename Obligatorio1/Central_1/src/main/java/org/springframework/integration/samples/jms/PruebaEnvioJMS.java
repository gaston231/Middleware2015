 ...
 */
public class PruebaEnvioJMS {

	public static void main(String[] args) {
		ClassPathXmlApplicationContext context =
			new ClassPathXmlApplicationContext("/META-INF/spring/integration/lealtadConf.xml");
		DestinationResolver<MessageChannel> channelResolver = new BeanFactoryChannelResolver(context);

//		 Compose the XML message according to the server's schema
		ArrayList<String> requestXml = new ArrayList<String>();
		requestXml.add("888-200");
		requestXml.add("888-1700");
		
		// Create the Message object
		Message<ArrayList<String>> message = MessageBuilder.withPayload(requestXml).build();
